...
<div class="w3-content w3-margin-top">
  ...
  <div class="w3-row-padding">
	...
	<a href="https://github.com/m5snow">
 	...
 	<a href="https://www.linkedin.com/in/mallory-snow-a64bb4250/">
	  ...
	  <div class="w3-light-grey w3-round-xlarge w3-small">
          ...
          <h6>SQL</h6>
	  <div class="w3-light-grey w3-round-xlarge w3-small">
        	<div class="w3-round-xlarge w3-pale-red" style="height:20px;width:65%"></div>
      	  </div>
          <h6>HTML/CSS</h6>
	  <div class="w3-light-grey w3-round-xlarge w3-small">
    ...
    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education</h2>
        <div class="w3-container">
	<a href="https://github.com/m5snow/m5snow.github.io/Projects.md">
...
><h6> <u>Click here for paper </u></h6></a>
	...
	<div class="w3-container">
          <h4 class="w3-text-dark-grey"> Interdisciplinary College (IK) Conference Attendee </h4>
	  <h6> Virtual event </h6>
